...
class SegmentationWidget(qt.QWidget):
    def __init__(self, logic=None, parent=None):
        ...
        self.modelComboBox.addItems(["dentalSegmentator", "PediatricDentalsegmentator","UniversalLabDentalsegmentator"])
    ...
    def selectFolder(self):
        ...
        if folderPath:
            ...
            self.folderFiles = list(folder.glob("*.nii*"))
    ...
    def onApplyClickedForVolume(self, volumeNode):
        ...
        if selectedModel == "PediatricDentalsegmentator":
            ...
            if not pediatricCheckpoint.exists():
                url_checkpoint = "https://github.com/ashmoy/tooth_seg/releases/download/model_ped_dentalseg/checkpoint_final.pth"
                url_dataset = "https://github.com/ashmoy/tooth_seg/releases/download/model_ped_dentalseg/dataset.json"
                url_plans = "https://github.com/ashmoy/tooth_seg/releases/download/model_ped_dentalseg/plans.json"
